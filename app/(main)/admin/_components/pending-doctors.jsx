...
import { Check, ExternalLink, ExternalLinkIcon, FileText, Medal, User, X } from 'lucide-react';
...
const PendingDoctors = ({ doctors }) => {
  ...
  <CardContent>
    {doctors.length === 0 ? (<div className='text-center py-8 text-muted-foreground'>
        No pending verification requests at this tim.
    </div>) 
    : 
  ...
  <DialogContent className="max-w-3xl">
    ...
    <div className="space-y-6 py-4">
              ...
              <div className='space-y-4' >
                    ...
                    <div className='grid grid-cold-1 md:grid-cols-2 gap-y-4 gap-x-6'>
