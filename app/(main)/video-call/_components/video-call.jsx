...
import { Loader, Loader2, Mic, MicOff, PhoneOff, User, Video, VideoOff } from 'lucide-react';
...
const VideoCall = ({ sessionId, token }) => {
    ...
    console.log("VideoCall Props:" , {sessionId, token ,appId});
    ...
    const initializeSession = () => {
        if(!appId || !sessionId || !token){
            toast.error("Missing required video call paramters");
