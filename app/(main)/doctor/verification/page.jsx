...
import { AlertCircle, ClipboardCheck, ClipboardCheckIcon, XCircle } from 'lucide-react';
            ...
            <Card className='border-emerald-900/20 '>
                <CardHeader className='text-center'>
                    ...
                    <CardDescription className='text-lg'>  
                        {isRejected ? 
                        "Unfortunately , your application needs revision" : "Thank you for submitting your information"}
                    </CardDescription>
                </CardHeader>
