    ...
    <Card className="border-emerald-900/20">
        <CardHeader>
            <CardTitle className="text-xl font-bold text-white flex items-center">
              ...
              <CardDescription>Set your daily availability</CardDescription>
           ...
           <CardContent>
            {!showForm ? (
              ...
              <div className='mb-6'>
                ...
                {slots.length === 0 ? 
                (<p className='text-muted-foreground'> You haven&apos;t set any availability slots yet .Add your availability to start acceptiong appointments </p>
